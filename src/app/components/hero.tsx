...
const Hero = () => {
  return (<main>
   <div className='bg-gray-200'> <div className='bg-gray-400 hover:bg-gray-500 mt-0 ml-60 mr-60'>
    ...
    </div><div className='text-align'>
    <h1 className='static ... flex justify-end text-left mt-6 mr-40 text-6xl font-medium'>Presidential Initiative</h1>
...
</div><div><h1 className="flex justify-center text-4xl tracking-widest font-black text-gray-500 font-mono ... mt-40">Available Programs</h1></div>


 <div className='absolute top-32 left-8 ... flex-start'><Image src="/president.png" alt="" width="390" height="290"></Image>
 </div></div></main>)
}
